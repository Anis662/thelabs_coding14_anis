<div class="modal fade edit25-{{ $i->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content p-5">
          <h1 class="text-center text-danger">Editez les Titres de service prime</h1>
        <form method="POST" action="/servicePrime/{{ $i->id }}">
            @csrf
            @method("put")
            @if ($errors->any())
