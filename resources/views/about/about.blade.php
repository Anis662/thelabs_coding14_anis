        ...
        <div class="container">
            <div class="row">
                ...
                {{-- <div class="col-md-4 col-sm-6">
                    <div class="lab-card">
                        <div class="icon">
                            <i class="{{ $serviceHome[$random3]->icone }}"></i>
                        </div>
                        <h2>{{ $serviceHome[$random3]->titre }}</h2>
                        <p>{{ $serviceHome[$random3]->text }}</p>
                    </div>
                </div>
                <!-- single card -->
    ...
    <div class="about-contant">
        <div class="container">
            ...
            <div class="text-center mt60">
                <a href="{{ route("contact") }}" class="site-btn">{{ $aboutContent->button }}</a>
            </div>
            <!-- popup video -->
